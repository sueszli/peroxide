...
/// This is the first step of the peer-to-peer connection protocol.
/// It creates a new `RtcPeerConnection` and sets up the necessary event handlers.
///
/// In this protocol, we have two roles:
///
