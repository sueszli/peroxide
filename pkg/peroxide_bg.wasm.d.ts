...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc00c2e2d0e40e8d2: (a: number, b: number) => void;
export const closure202_externref_shim: (a: number, b: number, c: any) => void;
export const closure220_externref_shim: (a: number, b: number, c: any, d: number, e: any) => void;
export const closure224_externref_shim: (a: number, b: number, c: any, d: any) => void;
