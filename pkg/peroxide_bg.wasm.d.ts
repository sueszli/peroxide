...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h992c9ad869e8a710: (a: number, b: number) => void;
export const closure164_externref_shim: (a: number, b: number, c: any) => void;
export const closure182_externref_shim: (a: number, b: number, c: any, d: number, e: any) => void;
export const closure186_externref_shim: (a: number, b: number, c: any, d: any) => void;
