...
export interface InitOutput {
  ...
  readonly closure88_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc00c2e2d0e40e8d2: (a: number, b: number) => void;
  readonly closure202_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure220_externref_shim: (a: number, b: number, c: any, d: number, e: any) => void;
