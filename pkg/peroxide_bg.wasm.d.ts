...
export const closure116_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure214_externref_shim: (a: number, b: number, c: any) => void;
export const closure232_externref_shim: (a: number, b: number, c: any, d: number, e: any) => void;
