...
export const closure164_externref_shim: (a: number, b: number, c: any, d: number, e: any) => void;
export const closure168_externref_shim: (a: number, b: number, c: any, d: any) => void;
